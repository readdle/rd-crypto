...
function RDCryptoV2(secret, salt) {
...
RDCryptoV2.prototype.encrypt = function (value) {
...
RDCryptoV2.prototype.decrypt = function (value) {
...
module.exports = function (secret, salt) {
    return new RDCryptoV2(secret, salt);
};
